...
The **Contributor Covenant** will guide community standards, and
**GitHub Discussions** will support collaboration and feedback.
**Monthly updates** and **quarterly summaries** will be provided for ISC
reviewers.
...
Development will span **8–9 months**, beginning **Nov/Dec 2025**,
and organized into four milestones:

| **Date**          | **Milestone**                                                            |
|-------------------|--------------------------------------------------------------------------|
| February 15, 2026 | Add the `soundex` algorithm and `semi` join type                         |
| April 15, 2026    | Align function signatures and output structures with `fuzzyjoin`         |
